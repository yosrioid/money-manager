            ...
            <div class="grid gap-3">
                <template v-for="category in section.items" :key="category.id">
                    <Form
                        ...
                        class="grid gap-3 rounded-lg border p-4 md:grid-cols-[1fr_auto_auto_auto]"
                        v-slot="{ errors, processing }"
                    >
                        <Input
                            name="name"
                    ...
                    <Form
                        ...
                        class="ml-6 grid gap-3 rounded-lg border border-dashed p-4 md:grid-cols-[1fr_auto_auto]"
                        v-slot="{ errors, processing }"
                    >
                        <Input
                            name="name"

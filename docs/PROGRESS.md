...
| F-009 | Transaction history and navigation              | `P3-01` to `P3-12` | In Review | -          |
| F-010 | Dashboard and fast-entry workflows              | `P3-13` to `P3-21` | In Review | -          |
...
| `P3-01` to `P3-21` | In Review | All Phase 3 features are implemented in [#14](https://github.com/yosrioid/money-manager/pull/14); `P3-14` is satisfied by the `P3-13` bookmark mechanism; review and Phase 3 exit-gate completion remain |

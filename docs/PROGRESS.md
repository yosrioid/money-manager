...
| `P3-01` to `P3-06` | In Progress | Daily transaction history, calendar, weekly, monthly, summary, and daily memo notes implemented on `feat/phase-3` |
| `P3-07` to `P8-10` | Planned  | See phase sequence and dependencies in `docs/MASTER_PLAN.md` |

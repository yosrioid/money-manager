...
| `P3-01` to `P3-07` | In Progress | Daily transaction history, calendar, weekly, monthly, summary, daily memo notes, and search implemented on `feat/phase-3` |
| `P3-08` to `P8-10` | Planned  | See phase sequence and dependencies in `docs/MASTER_PLAN.md` |

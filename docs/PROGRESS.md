...
| `P3-01` to `P3-02` | In Progress | Daily transaction history and calendar view implemented on `feat/phase-3` |
| `P3-03` to `P8-10` | Planned  | See phase sequence and dependencies in `docs/MASTER_PLAN.md` |

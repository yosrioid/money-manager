...
- Posted ledger entries are immutable. Corrections use reversal transactions.
- Use database transactions and row locking for ledger writes.
- Every query containing user financial data must be scoped to its workspace.
...
- Authorization, validation, and failure cases are handled.
- Required tests pass.
- Formatting and static analysis pass.
- Relevant documentation is updated.
- `docs/PROGRESS.md` records the completion, date, tests, and follow-up work.
